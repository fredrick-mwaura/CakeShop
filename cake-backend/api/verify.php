...
try {
    ...
    $insertStmt = $conn->prepare("INSERT INTO Login (Username, email, PasswordHash, Role) VALUES (?, ?, ?, ?)");
    $insertStmt->bind_param("ssss", $user['username'], $user['email'], $user['password'], $user['role']);
